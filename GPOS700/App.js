      ...
      <View>
        <TouchableOpacity style={{height: 96,flexDirection:"row",alignItems:'center',justifyContent:'center'}} onPress={() => this.props.navigation.navigate("CodigoDeBarra")}>
          ...
          <TouchableOpacity style={{height: 96,flexDirection:"row",alignItems:'center',justifyContent:'center'}} onPress={() => this.props.navigation.navigate("NfcGedi")}>
              ...
              <Image source={require('./images/nfc.png')} resizeMode='contain' style={{flex:.2 }} />

              <Text style={{flex:.8, fontSize: 15, textAlign: 'center'}}>NFC Gedi</Text>      
             
          </TouchableOpacity>
          <View style={{ height: 0.5, width: "100%", backgroundColor: "#000" }} />
          <TouchableOpacity style={{height: 96,flexDirection:"row",alignItems:'center',justifyContent:'center'}} onPress={() =>  this.props.navigation.navigate("NfcId")}>

              <Image source={require('./images/nfc1.png')} resizeMode='contain' style={{flex:.2 }} />

              <Text style={{flex:.8, fontSize: 15, textAlign: 'center'}}>NFC Id</Text>      
