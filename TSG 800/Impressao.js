...
import { AppRegistry, Text, TextInput, View ,StyleSheet,Button, ToasteModule, Icon, NativeModules,TouchableOpacity, Picker,NativeEventEmitter, DeviceEventEmitter, Alert} from 'react-native';  
...
export default class Impressao extends Component {  
    ...
    async componentDidMount(){
        ...
        DeviceEventEmitter.addListener("eventStatus",event=>{this.setState({statusPrint:event.status})}
      );
            ...
            <View>
                ...
                <View style={styles.fixToText}>
                    ...
                    <Button
                        ...
                        onPress={() =>this.imprimeTexto(this.state.input,this.state.language1,this.state.language2,this.state.toggle,this.state.toggle2,this.state.toggle3,this.state.value) }
           ...
           justifyContent: 'space-between',marginEnd:10}} >
                ...
                <View style={{marginTop: 20, marginLeft: 15, marginRight:15}}>
                    ...
                    <Button
                        ...
                        onPress={() => ToastExample.imprimeTudo()}
                    />
