...
public class CodigoBarras222 extends ReactActivity implements View.OnClickListener, ZXingScannerView.ResultHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityCompat.requestPermissions(CodigoBarras222.this,
        ...
        switch (requestCode) {
            case 1: {
                if (grantResults.length > 0
                    ...
                    Toast.makeText(CodigoBarras222.this, ACESSO_NEGADO, Toast.LENGTH_SHORT).show();
                }
                return;
            }
        }
    ...
    public void handleResult(Result result) {
        ...
        //Aciona o beep
        AlertDialog alertDialog = new AlertDialog.Builder(CodigoBarras222.this).create();
